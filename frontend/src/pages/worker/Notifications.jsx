    ...
    <div className="w-full min-h-[calc(100vh-4rem)] h-full overflow-y-auto px-4 sm:px-6 py-4 flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between mb-4 gap-3">
        ...
        <div className="flex flex-wrap gap-2 w-full sm:w-auto">
          <button
            className="px-3 py-2 rounded-lg bg-[var(--accent)] text-black text-sm font-semibold flex items-center justify-center gap-2 shadow transition hover:bg-[var(--accent)]/80 flex-1"
            onClick={() => {
              const csv = [
                ["Message", "Read"],
              ...
              a.href = url;
              a.download = "worker_notifications.csv";
              a.click();
